...
@implementation DeliveryRecordHeaderView
...
- (void)buttonPressed:(UIButton *)sender
{
    ...
    if (_delegate &&[_delegate respondsToSelector:@selector(headerViewSelctAction:index:)]){
        [self.delegate headerViewSelctAction:self index:sender.tag - 10];
    }
