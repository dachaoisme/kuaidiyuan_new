...
@class DeliveryRecordHeaderView;
@protocol DeliveryRecordHeaderViewDelegate <NSObject>
...
@interface DeliveryRecordHeaderView : UIView
...
@property (assign, nonatomic) id<DeliveryRecordHeaderViewDelegate> delegate;
